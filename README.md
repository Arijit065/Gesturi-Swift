...
- **Home Screen**: Clean welcome page with the app logo and a prominent "Let's Start" button. ![Home screen showing the Gesturio logo, app name, tagline, and a blue start button](screenshots/home-page.jpeg)
